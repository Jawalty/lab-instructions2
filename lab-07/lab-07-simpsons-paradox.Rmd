...
This is an observational study because it's based on the status of people who smoke, which are common enough in society to be their own focus group.
...
The dataset has `r nrow(Whickham)` observations. Each observation represents 
...
I would expect that smokers would have declining health, as well as a surge in younger death rates.
...
ggplot(data = Whickham, aes(x = smoker, fill = outcome)) +
  ...
  labs(
    title = "Smoking Status vs Health Outcome",
    x = "Smoker",
    y = "Proportion",
    fill = "Outcome"
  )
...
- Proportion of smokers who are alive after 20 years: 76.1%
- Proportion of non-smokers who are alive after 20 years: 68.5%

**Does this meet your expectations? What do you notice?** Right away im noticing that the smokers have a higher percentage of alive rates compared to the non-smokers. You would expect the smokers to have higher death rates.
