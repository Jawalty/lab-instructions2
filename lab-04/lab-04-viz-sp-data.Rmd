...
**Your answer:** The Denny's dataset has `r nrow(dennys)` rows and `r ncol(dennys)` columns. Each row represents A differnt Denny's location. The variables are the details about the location.
...
**Your answer:** The La Quinta dataset has `r nrow(laquinta)` rows and `r ncol(laquinta)` columns. Each row represents a different estate. The variables are the details of each location.
...
**Your ideas:**
- If you look at the cities listed, there are quite a few that stick out to being non-US.
- If youre well educated on coordinated you could figure out some with the data listed.
- 
...
**How many Denny's locations are outside the US?** It's telling me zero.

**If there are any, which state/province codes appear?** NA
